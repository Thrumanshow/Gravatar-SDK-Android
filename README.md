...
## Artículo 1: Hormigasai SA
Fecha de publicación: 4 de diciembre de 2024

Hormigasai SA es una empresa dedicada al marketing de inteligencia artificial. Sus principales aplicaciones incluyen Hormigasai App, Hormigasai Web y HormigasAIS.

### Integraciones
Hormigasai SA integra herramientas como GitHub, Slack, Trello, HubSpot, WordPress, Asana, Family Safety, Bitdefender y VPN.

### Correos Vinculados
Los correos electrónicos vinculados al proyecto incluyen:
...
- **Repositorios**:
  - **heroku-wp**: Configuración inicial de despliegue en Heroku.
  - **Hormigasai**: Proyecto principal de Hormigasai SA
  - **Robots**:
    - **Bot de Atención al Cliente**: Automatización de respuestas a clientes.
    - **Bot de Redes Sociales**: Gestión y análisis de redes sociales.
...
- **Dirección**: Calle Ávalos Casa #210
- **Código Postal**: 3301
- **OpenStreetMap**: Ubicación en el mapa

### Referencias
1. Hormigasai S.A. (2024, enero 1). Título del artículo. Medium. https://medium.com/ejemplo
2. Quiñonez, C. (2024, enero 1). Asunto del correo [Mensaje de correo electrónico]. Slack. destinatario@ejemplo.com

---

[[Categoría:Empresas tecnológicas]]
[[Categoría:Tipos de empresas]]
[[Categoría:Actividades empresariales]]
...
Read our [Contributing Guide](CONTRIBUTING.md) to learn about <p align="center">
    <img src="/docs/images/gravatar_logo.png" />
</p>
...
reporting issues, contributing code, and more ways to contribute.
